...
<body>
    ...
    <span class="game-title-text">Valorant</span>
</div>
        ...
        <div class="step riot-id-section">
            ...
            <div class="step-content">
                <label for="riot-id">ID Valorant</label>
 ...
 <div class="step">
    ...
    console.log("Update Payment Details Called");

    // Update Riot ID
    console.log("Riot ID:", riotIdInput.value);
    displayRiotId.textContent = riotIdInput.value || '-';

    // Update Selected Package
    const selectedPackage = document.querySelector('input[name="amount"]:checked');
    if (selectedPackage) {
        console.log("Selected Package:", selectedPackage.dataset.description);
    ...
    if (selectedPayment) {
        ...
        displayPaymentMethod.textContent = '-';
